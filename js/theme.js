...
$(document).ready(function () {
          ...
          $('.tabb').click(function () {
            ...
            $(".tabb").not(this).removeClass('active');
            $(".tabb").not(this).addClass('bg-white');
            $(this).children('a').removeClass('nav-linkk');
            $(".tabb").not(this).children('a').removeClass('floating-button');
            $(this).children('a').addClass('floating-button');
          });


          $('.rep-btn-1').click(function () {
            // $(this).toggleClass('active');
            $('.rep-section-1').toggleClass('d-block');
          });

          $('.rep-btn-2').click(function () {
            // $(this).toggleClass('active');
            $('.rep-section-2').toggleClass('d-block');
          });

          $('.rep-btn-3').click(function () {
            // $(this).toggleClass('active');
            $('.rep-section-3').toggleClass('d-block');
          });
          ...
          $('.follow-btn').click(function () {
            ...
            $(".unfollow-btn").toggleClass('d-block');
          });

          $('.unfollow-btn').click(function () {
            $(this).removeClass('d-block');
            $(this).addClass('d-none');
            $(".follow-btn").toggleClass('d-block');
          });
});
// multiple upload
...
jQuery(document).ready(function() {
    ...
    jQuery('#upload_imgs').on('change', previewImgs);
    jQuery(document).on('click', '.close-btn', removeImgs);

});


function previewImgs() {
    var imgPreview = jQuery('#img_preview'),
        totalFiles = this.files;
    ...
    for (var i = 0; i < totalFiles.length; i++) {
        ...
        jQuery('<img>').attr({
            ...
            src: URL.createObjectURL(totalFiles[i])
...
function removeImgs(event) {
    var imgUpload = jQuery('#upload_imgs');
    var item = jQuery(event.target).attr('id');
    var removing_item = parseInt(item.substring(item.length - 1, item.length));
  var totalFiles = imgUpload[0].files;
...
jQuery(document).ready(function() {
    ...
    $(".paymentt-card").click(function() {
        $(".paymentt-box").slideToggle();
    });

    $(".paymenttt-card").click(function() {
        $(".paymenttt-box").slideToggle();
    });
